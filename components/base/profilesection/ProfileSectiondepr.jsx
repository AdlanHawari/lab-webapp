...
import { userDummy } from "constants/test_objects/userDummy";
import { useAuth } from "hooks/fetcher/auth/useAuth";
import useUser from "hooks/fetcher/auth/useUser";
import { useEffect, useRef, useState } from "react";
import MenuItem from "../sidemenu/MenuItem";

export default function ProfileSectiondepr() {

  const [passwordVal, setPasswordVal] = useState(userDummy[userDummy.length-1].data);
